...
export default class AccessibilityModal extends Modal {
    static TYPE = "theme_certify/themesettings_modal";
    static TEMPLATE = "theme_certify/accessibilitysettings_modal";

    constructor(root) {
        super(root);

        let request = Ajax.call([{
            methodname: 'theme_certify_getthemesettings',
            args: {}
        }]);
    ...
    registerEventListeners() {
        ...
        this.getModal().on(CustomEvents.events.activate, '[data-action="save"]', function() {
            let request = Ajax.call([{
                methodname: 'theme_certify_savethemesettings',
                args: {
