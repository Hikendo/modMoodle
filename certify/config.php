...
$THEME->scss = function($theme) {
    return theme_certify_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_certify_get_extra_scss';
$THEME->prescsscallback = 'theme_certify_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_certify_get_precompiled_css';
$THEME->yuicssmodules = [];
