...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('certify');
    }
    ...
    public function frontpage_slideshow() {
        ...
        $defaultimage = new \moodle_url('/theme/certify/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes() {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/certify/pix/default_markegingicon.svg');
