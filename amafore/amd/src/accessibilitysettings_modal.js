...
export default class AccessibilityModal extends Modal {
    static TYPE = "theme_amafore/themesettings_modal";
    static TEMPLATE = "theme_amafore/accessibilitysettings_modal";

    constructor(root) {
        super(root);

        let request = Ajax.call([{
            methodname: 'theme_amafore_getthemesettings',
            args: {}
        }]);
    ...
    registerEventListeners() {
        ...
        this.getModal().on(CustomEvents.events.activate, '[data-action="save"]', function() {
            let request = Ajax.call([{
                methodname: 'theme_amafore_savethemesettings',
                args: {
