...
$THEME->scss = function($theme) {
    return theme_amafore_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_amafore_get_extra_scss';
$THEME->prescsscallback = 'theme_amafore_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_amafore_get_precompiled_css';
$THEME->yuicssmodules = [];
